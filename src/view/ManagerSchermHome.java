 ...
 * @author EdoTjioe
 */
public class ManagerSchermHome extends javax.swing.JFrame {

    /**
     * Creates new form ManagerSchermHome
     */
    public ManagerSchermHome() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagerSchermHome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManagerSchermHome().setVisible(true);
            }
        });
    }
